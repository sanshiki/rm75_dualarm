...
def _realsense_camera(
    ...
    return IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "depth_module.enable_auto_exposure": depth_auto_exposure,
            "gyro_fps": gyro_fps,
            "accel_fps": accel_fps,
            "unite_imu_method": unite_imu_method,
            "enable_sync": enable_sync,
...
def generate_launch_description():
    ...
    for name, default, description in (
        ...
        ("align_depth", defaults["align_depth"], "Enable RealSense align_depth filter"),
        ("pointcloud", defaults["pointcloud"], "Enable RealSense pointcloud filter"),
        ("color_profile", defaults["color_profile"], "RealSense rgb_camera.color_profile"),
        ("color_format", defaults["color_format"], "RealSense rgb_camera.color_format"),
        ("color_auto_exposure", defaults["color_auto_exposure"], "RealSense rgb_camera.enable_auto_exposure"),
        ("depth_profile", defaults["depth_profile"], "RealSense depth_module.depth_profile"),
        ("depth_auto_exposure", defaults["depth_auto_exposure"], "RealSense depth_module.enable_auto_exposure"),
