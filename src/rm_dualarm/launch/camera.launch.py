...
#   ros2 launch rm_dualarm camera.launch.py camera_params_file:=/path/to/camera_params.yaml
# ================================================================
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument("camera_params_file", default_value=default_params_file))
